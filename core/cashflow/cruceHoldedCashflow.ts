...
import { esProblemaEstructuraSevero, parsearImporteCashflow } from "./parseoImportes";

// Reexportados: otros módulos (y sus tests) los importan desde aquí.
export { esProblemaEstructuraSevero, parsearImporteCashflow };
